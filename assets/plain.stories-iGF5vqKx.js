import{e as u,j as e}from"./editable-BlpPuhUA.js";import{r as t}from"./iframe-C3nsfmav.js";import{I as Q,D as X}from"./commands-BGCXrFBF.js";import{p as c}from"./plain-mCYhco5B.js";const re={component:u},m={render:()=>{const n=t.useRef(null),[s,o]=t.useState(`Hello World.
こんにちは。
...
}`,...(N=(K=y.parameters)==null?void 0:K.docs)==null?void 0:N.source}}};const te=["Multiline","Singleline","Readonly","Placeholder","Highlight","Command","SpanAsBlock","Rtl","Vertical"];export{g as Command,v as Highlight,m as Multiline,h as Placeholder,p as Readonly,x as Rtl,f as Singleline,b as SpanAsBlock,y as Vertical,te as __namedExportsOrder,re as default};
