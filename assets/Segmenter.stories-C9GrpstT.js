import{e as h,j as e}from"./editable-CkuiWCn3.js";import{r as t}from"./iframe-Rko2uH-U.js";import{p as x}from"./plain-DKrl9fQ0.js";import"./preload-helper-Dp1pzeXC.js";const C={component:h},f={width:"300px",height:"200px",background:"white"},j=({text:a,segmenter:l})=>{const r=l.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},i={render:()=>{const[a,l]=t.useState(`すもももももももものうち。
...
}`,...(g=(m=i.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};const E=["Segmenter"];export{i as Segmenter,E as __namedExportsOrder,C as default};
