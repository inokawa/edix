import{e as h,j as e}from"./editable-Dl4657gw.js";import{r as t}from"./index-RYns6xqu.js";import{p as x}from"./plain-CpjLCkNt.js";const b={component:h},f={width:"300px",height:"200px",background:"white"},j=({text:a,segmenter:i})=>{const r=i.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},l={render:()=>{const[a,i]=t.useState(`すもももももももものうち。

吾輩 （ わがはい ） は猫である。名前はまだ無い。`),r=t.useRef(null);t.useEffect(()=>{if(r.current)return h(r.current,{schema:x({multiline:!0}),onChange:i})},[]);const[n,u]=t.useState("ja"),[s,c]=t.useState("word"),d=t.useMemo(()=>Intl!=null&&Intl.Segmenter?new Intl.Segmenter(n,{granularity:s}):null,[n,s]);return d?e.jsxs("div",{children:[e.jsxs("div",{children:[e.jsxs("select",{value:n,onChange:o=>u(o.target.value),children:[e.jsx("option",{value:"ja",children:"ja"}),e.jsx("option",{value:"en",children:"en"})]}),e.jsxs("select",{value:s,onChange:o=>c(o.target.value),children:[e.jsx("option",{value:"grapheme",children:"grapheme"}),e.jsx("option",{value:"word",children:"word"}),e.jsx("option",{value:"sentence",children:"sentence"})]})]}),e.jsx("div",{ref:r,style:f,children:a.split(`
`).map((o,v)=>e.jsx(j,{text:o,segmenter:d},v))})]}):e.jsx("div",{children:"Intl.Segmenter is not supported in this browser."})}};var p,m,g;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
...
}`,...(g=(m=l.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};const C=["Segmenter"];export{l as Segmenter,C as __namedExportsOrder,b as default};
