import{e as h,j as e}from"./editable-DIoj01mN.js";import{r as t}from"./index-RYns6xqu.js";import{p as x}from"./plain-DNmB8OPO.js";const b={component:h},f={width:"300px",height:"200px",background:"white"},j=({text:a,segmenter:l})=>{const r=l.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},i={render:()=>{const[a,l]=t.useState(`すもももももももものうち。
