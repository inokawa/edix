import{e as u,j as e}from"./editable-D1SP0diL.js";import{r as t}from"./index-RYns6xqu.js";const se={component:u},c={render:()=>{const n=t.useRef(null),[i,o]=t.useState(`Hello World.
こんにちは。
...
`).map((a,d)=>e.jsx("div",{children:a||e.jsx("br",{})},d))})]})}},f={render:()=>{const n=t.useRef(null),[i,o]=t.useState(`אחד !
two !
...
`).map((r,s)=>e.jsx("div",{children:r||e.jsx("br",{})},s))})}},m={render:()=>{const n=t.useRef(null),[i,o]=t.useState(`春は、あけぼの。やうやうしろくなりゆく山ぎは、すこし明かりて、紫だちたる雲の、細くたなびきたる。
...
`).map((r,s)=>e.jsx("div",{children:r||e.jsx("br",{})},s))})}},v={render:()=>{const n=t.useRef(null),[i,o]=t.useState("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."),[r,s]=t.useState("dolor");t.useEffect(()=>{if(n.current)return u(n.current,{onChange:o})},[]);const l=new RegExp(`(${r})`);return e.jsxs("div",{children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"search",children:"input search word: "}),e.jsx("input",{name:"search",value:r,onChange:a=>s(a.target.value)})]}),e.jsx("div",{ref:n,style:{background:"white"},children:i.split(`
`).map((a,d)=>e.jsx("div",{children:a?a.split(l).map((y,B)=>e.jsx("span",{style:{background:y===r?"yellow":void 0},children:y},B)):e.jsx("br",{})},d))})]})}},J="[TAG:",Q=({children:n})=>e.jsx("span",{contentEditable:!1,style:{background:"slategray",color:"white",padding:4,borderRadius:8},children:n}),h={render:()=>{const n=t.useRef(null),[i,o]=t.useState("Hello [TAG:TAG1] world [TAG:TAG2]");return t.useEffect(()=>{if(n.current)return u(n.current,{onChange:o,nodes:[{is:r=>r.contentEditable==="false",serialize:r=>r.textContent}]})},[]),e.jsx("div",{ref:n,style:{backgroundColor:"white",padding:8},children:i.split(`
`).map((r,s)=>e.jsx("div",{children:r?r.split(/(\[.+?\])/).map((l,a)=>l.startsWith(J)?e.jsx(Q,{children:l},a):e.jsx("span",{children:l},a)):e.jsx("br",{})},s))})}},O="[image:",Z=({text:n})=>{const i=n.slice(O.length,n.length-1);return e.jsx("img",{src:i})},g={render:()=>{const n=t.useRef(null),[i,o]=t.useState("Hello [image:https://loremflickr.com/320/240/cats?lock=1] world [image:https://loremflickr.com/320/240/cats?lock=2]");return t.useEffect(()=>{if(n.current)return u(n.current,{onChange:o,nodes:[{is:"img",serialize:r=>`[image:${r.src}]`}]})},[]),e.jsx("div",{ref:n,style:{backgroundColor:"white",padding:8},children:i.split(`
`).map((r,s)=>e.jsx("div",{children:r?r.split(/(\[.+?\])/).map((l,a)=>l.startsWith(O)?e.jsx(Z,{text:l},a):e.jsx("span",{children:l},a)):e.jsx("br",{})},s))})}},U="[video:",ee=({text:n})=>{const i=n.slice(U.length,n.length-1);return e.jsx("video",{width:400,controls:!0,children:e.jsx("source",{src:i})})},b={render:()=>{const n=t.useRef(null),[i,o]=t.useState("Hello [video:https://download.samplelib.com/mp4/sample-5s.mp4] world");return t.useEffect(()=>{if(n.current)return u(n.current,{onChange:o,nodes:[{is:"video",serialize:r=>`[video:${r.childNodes[0].src}]`}]})},[]),e.jsx("div",{ref:n,style:{backgroundColor:"white",padding:8},children:i.split(`
`).map((r,s)=>e.jsx("div",{children:r?r.split(/(\[.+?\])/).map((l,a)=>l.startsWith(U)?e.jsx(ee,{text:l},a):e.jsx("span",{children:l},a)):e.jsx("br",{})},s))})}},ne=({id:n})=>e.jsx("iframe",{"data-youtube-node":!0,"data-youtube-id":n,width:"560",height:"315",src:"https://www.youtube.com/embed/"+n,frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}),x={render:()=>{const n=t.useRef(null),[i,o]=t.useState("Hello [IqKz0SfHaqI] Youtube"),r=t.useRef(null);return t.useEffect(()=>{if(n.current)return r.current=u(n.current,{onChange:o,nodes:[{is:s=>!!s.dataset.youtubeNode,serialize:s=>"["+s.dataset.youtubeId+"]"}]})},[]),e.jsxs("div",{children:[e.jsx("div",{children:e.jsx("button",{onClick:()=>{var s;(s=r.current)==null||s.insert(" [IqKz0SfHaqI]")},children:"insert"})}),e.jsx("div",{ref:n,style:{backgroundColor:"white",padding:8},children:i.split(`
`).map((s,l)=>e.jsx("div",{children:s.split(/(\[.+?\])/).map((a,d)=>a.startsWith("[")?e.jsx(ne,{id:a.slice(1,a.length-1)},d):e.jsx("span",{children:a},d))},l))})]})}};var j,k,E;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
  ...
  render: () => {
    ...
    return <div>
        ...
        background: "white"
          ...
          {value.split("\\n").map((r, i) => <div key={i}>
              {r ? r.split(reg).map((t, j) => <span key={j} style={{
