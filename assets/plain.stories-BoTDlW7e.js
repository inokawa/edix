import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{C as n}from"./iframe-nDT0LqTt.js";import{t as r}from"./jsx-runtime-O9QVJvLM.js";import{A as i,D as a,E as o,N as s,O as c,T as l,n as u,t as d}from"./src-DLNdB8W5.js";var f,p,m,h,g,_,v,y,b,x,S,C,w;t((()=>{f=e(n()),d(),p=r(),m={component:u},h={render:()=>{let e=(0,f.useRef)(null),[t,n]=(0,f.useState)(`Hello world.
こんにちは。
...
冬は、つとめて。雪の降りたるは、言ふべきにもあらず。霜のいと白きも。またさらでも、いと寒きに、火など急ぎおこして、炭持てわたるも、いとつきづきし。昼になりて、ぬるくゆるびもていけば、火桶の火も、白き灰がちになりて、わろし。`);return(0,f.useEffect)(()=>{if(e.current)return u({text:t,onChange:n}).input(e.current)},[]),(0,p.jsx)(`div`,{ref:e,style:{writingMode:`vertical-rl`,background:`white`,height:400},children:t.split(`
