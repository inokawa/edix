import{e as i,j as e}from"./editable-CzuDXj-g.js";import{r}from"./index-RYns6xqu.js";const $={component:i},d={render:()=>{const n=r.useRef(null),[a,l]=r.useState(`Hello World.
こんにちは。
...
`).map((t,u)=>e.jsx("div",{children:t||e.jsx("br",{})},u))})}},c={render:()=>{const n=r.useRef(null),[a,l]=r.useState("Hello World.");return r.useEffect(()=>{if(n.current)return i(n.current,{onChange:l})},[]),e.jsx("div",{ref:n,style:{backgroundColor:"white",border:"solid 1px darkgray",padding:8},children:a||e.jsx("br",{})})}},f={render:()=>{const n=r.useRef(null),[a,l]=r.useState("Hello world."),[t,u]=r.useState(!1),o=r.useRef(null);return r.useEffect(()=>{if(n.current)return o.current=i(n.current,{onChange:l})},[]),e.jsxs("div",{children:[e.jsx("div",{children:e.jsx("button",{onClick:()=>{if(!o.current)return;const s=!t;o.current.readonly(s),u(s)},children:t?"editable":"readonly"})}),e.jsx("div",{ref:n,style:{background:"white",color:t?"gray":void 0},children:a||e.jsx("br",{})})]})}},m={render:()=>{const n=r.useRef(null),[a,l]=r.useState(`אחד !
two !
...
`).map((t,u)=>e.jsx("div",{children:t||e.jsx("br",{})},u))})}},p={render:()=>{const n=r.useRef(null),[a,l]=r.useState(`春は、あけぼの。やうやうしろくなりゆく山ぎは、すこし明かりて、紫だちたる雲の、細くたなびきたる。
...
`).map((t,u)=>e.jsx("div",{children:t||e.jsx("br",{})},u))})}},v={render:()=>{const n=r.useRef(null),[a,l]=r.useState("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."),[t,u]=r.useState("dolor");r.useEffect(()=>{if(n.current)return i(n.current,{multiline:!0,onChange:l})},[]);const o=t?new RegExp(`(${t})`):null;return e.jsxs("div",{children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"search",children:"search word"}),e.jsx("input",{name:"search",value:t,onChange:s=>u(s.target.value)})]}),e.jsx("div",{ref:n,style:{background:"white"},children:a.split(`
`).map((s,W)=>e.jsx("div",{children:s?(o?s.split(o):[s]).map((h,_)=>e.jsx("span",{style:{background:h===t?"yellow":void 0},children:h},_)):e.jsx("br",{})},W))})]})}};var g,b,x;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
