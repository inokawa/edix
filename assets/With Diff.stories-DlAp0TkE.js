...
`)?f.slice(0,-1):f).split(`
`),i=se(n,t);let a=0,s=0;const l={},c={};for(let f=0;f<i.length;f++){const{removed:d,added:g,value:m}=i[f],h=r(m);if(!d&&!g&&(a+=h.length,s+=h.length),d){const C=i[f+1];if(C&&C.added){const T=r(C.value),w=Math.max(h.length,T.length);for(let y=0;y<w;y++){const v=h[y],p=T[y];if(v!=null&&p!=null){const D=re(v,p);l[a]=D,c[s]=D}v!=null&&(l[a]||(l[a]=!0),a++),p!=null&&(c[s]||(c[s]=!0),s++)}f++;continue}for(const T of h)l[a]=!0,a++}if(g)for(const C of h)c[s]=!0,s++}return{base:l,target:c}},[n,t]);return L.jsxs("div",{style:{display:"flex",gap:4,width:"100vw"},children:[L.jsx(S,{type:"base",result:u.base,value:n,onChange:e}),L.jsx(S,{type:"target",result:u.target,value:t,onChange:o})]})}};var U,X,Y;R.parameters={...R.parameters,docs:{...(U=R.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => {
...
}`,...(Y=(X=R.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const he=["WithDiff"];export{R as WithDiff,he as __namedExportsOrder,me as default};
