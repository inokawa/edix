import{e as v,j as e}from"./editable-B9eS-CXd.js";import{r as t}from"./index-RYns6xqu.js";const S={component:v},x={width:"300px",height:"200px",background:"white"},f=({text:a,segmenter:i})=>{const r=i.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},l={render:()=>{const[a,i]=t.useState(`すもももももももものうち。
