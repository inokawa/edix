import{e as m,j as e}from"./editable-C5ahX20V.js";import{r as s}from"./index-RYns6xqu.js";const w={component:m},x={width:"300px",height:"200px",background:"white"},f=({text:o,segmenter:l})=>{const n=l.segment(o),t=[];for(const{segment:u,index:a,isWordLike:c}of n)t.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},a));return e.jsx("div",{children:o?t:e.jsx("br",{})})},i={render:()=>{const[o,l]=s.useState(`すもももももももものうち。
