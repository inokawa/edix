import{e as p,j as t}from"./editable-DKuijTdl.js";import{r}from"./iframe-r5y2RgDL.js";import{r as w}from"./index-ssfiOTts.js";import{p as m}from"./plain-wrRlUwAw.js";import"./index-I_dVijIZ.js";const E={component:p},f=()=>{const n=r.useRef(null),[o,s]=r.useState("This is new window!");return r.useEffect(()=>{if(n.current)return p(n.current,{schema:m({multiline:!0}),onChange:s}).dispose},[]),t.jsx("div",{ref:n,style:{background:"white"},children:o.split(`
