import{e as h,j as e}from"./editable-DwAU-FRE.js";import{r as t}from"./index-Bk3ZmH4I.js";import{p as x}from"./plain-sHpL81po.js";const b={component:h},f={width:"300px",height:"200px",background:"white"},j=({text:a,segmenter:l})=>{const r=l.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},i={render:()=>{const[a,l]=t.useState(`すもももももももものうち。
