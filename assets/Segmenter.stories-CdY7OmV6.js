import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as t}from"./iframe-CNd-ZHfW.js";import{e as h}from"./editable-CCMxu8sI.js";import{p as x}from"./plain-D-4OW2an.js";import"./preload-helper-Dp1pzeXC.js";const E={component:h},f={width:"300px",height:"200px",background:"white"},j=({text:a,segmenter:l})=>{const r=l.segment(a),n=[];for(const{segment:u,index:s,isWordLike:c}of r)n.push(e.jsx("span",{style:{background:c?"palegreen":void 0,outline:"solid 1px green"},children:u},s));return e.jsx("div",{children:a?n:e.jsx("br",{})})},i={render:()=>{const[a,l]=t.useState(`すもももももももものうち。
...
}`,...(g=(m=i.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};const G=["Segmenter"];export{i as Segmenter,G as __namedExportsOrder,E as default};
