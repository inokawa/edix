...
test.describe("Keydown", () => {
  ...
  test.describe("User defined shortcuts", () => {
    test("combobox", async ({ page }) => {
      ...
      expect(updatedA[0].length).toBeGreaterThan(textA.length);
      ...
      expect(updatedB[0].length).toBeGreaterThan(textB.length);
